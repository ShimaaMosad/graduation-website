    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-sm text-gray-500 hover:text-gray-800">Marketplace</a>
            <a href="#" className="text-sm text-gray-500 hover:text-gray-800">Messages</a>
            <a href="#" className="text-sm text-purple-600 font-medium border-b-2 border-purple-600 pb-0.5">Projects</a>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className="w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center text-white text-xs font-bold">AS</div>
          </div>
        </div>
      </nav>
